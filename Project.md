...
### TODO для Фазы 3
- [ ] Перезапустить batch с теми же 3 сделками после миграции 002
- [ ] Проверить что все 3 таблицы заполнились (lost_deals: 2 записи, 97861 отфильтрована; lost_deal_communications: ~50+ записей; lost_deal_analyses: 2 записи с ai_* = null)
- [ ] Прогнать вторым батчем оставшиеся сделки 108811, 109919 + добить до ~20-30 исторических
- [ ] Починить блокировку claudemcpcontent.com у Сани → полный MCP вернётся
